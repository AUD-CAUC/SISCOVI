...
public class HistoricoGestorModel {
    ...
    public HistoricoGestorModel(int codigo, int codigoContrato, int codigoPerfilGestao, String gestor, String sigla, Date inicio, Date fim, String loginAtualizacao, Date dataAtualizacao) {
        this.codigo = codigo;
